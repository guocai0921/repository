...
// Source File Name:   FieldProviderTransformer.java
...
public class FieldProviderTransformer extends ClassEmitterTransformer
{
	...
	private void generate()
		throws Exception
	{
		String names[] = (String[])(String[])fields.keySet().toArray(new String[fields.size()]);
	...
	private void setByIndex(final String names[], int indexes[])
		throws Exception
	{
		...
		e.process_switch(indexes, new ProcessSwitchCallback() {
			...
			final FieldProviderTransformer this$0;
			...
			{
				this.this$0 = FieldProviderTransformer.this;
				names = as;
				e = codeemitter;
				super();
			}
	...
	private void getByIndex(final String names[], int indexes[])
		throws Exception
	{
