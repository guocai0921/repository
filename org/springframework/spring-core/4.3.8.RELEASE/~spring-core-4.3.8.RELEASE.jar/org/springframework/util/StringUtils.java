...
public abstract class StringUtils
{
	...
	private static void validateLocalePart(String localePart)
	{
		for (int i = 0; i < localePart.length(); i++)
		{
			...
			if (ch != ' ' && ch != '_' && ch != '#' && !Character.isLetterOrDigit(ch))
				throw new IllegalArgumentException((new StringBuilder()).append("Locale part \"").append(localePart).append("\" contains invalid characters").toString());
		}
	...
	{
		return (new StringBuilder()).append(locale.getLanguage()).append(hasText(locale.getCountry()) ? (new StringBuilder()).append("-").append(locale.getCountry()).toString() : "").toString();
	}
	...
	public static TimeZone parseTimeZoneString(String timeZoneString)
	{
		...
		if ("GMT".equals(timeZone.getID()) && !timeZoneString.startsWith("GMT"))
			throw new IllegalArgumentException((new StringBuilder()).append("Invalid time zone specification '").append(timeZoneString).append("'").toString());
		else
			return timeZone;
	}
